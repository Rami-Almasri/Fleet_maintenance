 ...
 *
 *   1. EXCLUSIVITY. A request says why exactly ONE way — a named fault, a reason code, or a note.
 *      If naming a fault AND picking a reason ever started being accepted, nothing would crash; the
 *      ticket would simply carry two contradictory answers and every downstream reader would pick a
 *      different one.
 *   2. PROVENANCE. A named fault must come from the live vocabulary or from THIS car's own history.
 *      A hand-typed fault name would look identical in the column and be invisible to every catalog
 *      join, recurrence match and count that makes the field worth having.
 *
