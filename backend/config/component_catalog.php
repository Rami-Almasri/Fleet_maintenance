...
return [
    ...
    ['slug' => 'water-pump',    'name' => 'Water Pump',       'category_key' => 'engine',       'tracking_mode' => 'serialized', 'default_warranty_months' => 12, 'expected_life_km' => 120000, 'position_scheme' => null],
    ...
    ['slug' => 'ac-condenser',  'name' => 'AC Condenser',     'category_key' => 'ac',           'tracking_mode' => 'serialized', 'default_warranty_months' => 12, 'expected_life_km' => 150000, 'position_scheme' => null],
    ['slug' => 'radiator-fan',  'name' => 'Radiator Fan',     'category_key' => 'engine',       'tracking_mode' => 'serialized', 'default_warranty_months' => 12, 'expected_life_km' => 150000, 'position_scheme' => null],
    ...
    ['slug' => 'clutch-kit',    'name' => 'Clutch Kit',       'category_key' => 'transmission', 'tracking_mode' => 'serialized', 'default_warranty_months' => 12, 'expected_life_km' => 120000, 'position_scheme' => null],
    ...
    ['slug' => 'cabin-filter',  'name' => 'Cabin Filter',     'category_key' => 'ac',           'tracking_mode' => 'batch', 'expected_life_km' => 20000, 'expected_life_months' => 12, 'position_scheme' => null],
    ['slug' => 'fuel-filter',   'name' => 'Fuel Filter',      'category_key' => 'engine',       'tracking_mode' => 'batch', 'expected_life_km' => 40000, 'position_scheme' => null],
    ['slug' => 'spark-plugs',   'name' => 'Spark Plugs (set)', 'category_key' => 'engine',      'tracking_mode' => 'batch', 'expected_life_km' => 60000, 'position_scheme' => null,
        'notes' => 'CONVENTION: one set per engine, qty=1 (never per-plug).'],
    ['slug' => 'ignition-coil', 'name' => 'Ignition Coil',    'category_key' => 'electrical',   'tracking_mode' => 'batch', 'expected_life_km' => 100000, 'position_scheme' => null],
    ...
    ['slug' => 'timing-chain',  'name' => 'Timing Chain',     'category_key' => 'engine',       'tracking_mode' => 'batch', 'expected_life_km' => 200000, 'position_scheme' => null],
    ['slug' => 'drive-belt',    'name' => 'Drive / Serpentine Belt', 'category_key' => 'engine', 'tracking_mode' => 'batch', 'expected_life_km' => 60000, 'position_scheme' => null],
    ['slug' => 'thermostat',    'name' => 'Thermostat',       'category_key' => 'engine',       'tracking_mode' => 'batch', 'expected_life_km' => 120000, 'position_scheme' => null],
    ['slug' => 'oxygen-sensor', 'name' => 'Oxygen Sensor',    'category_key' => 'engine',       'tracking_mode' => 'batch', 'expected_life_km' => 100000, 'position_scheme' => null],
    ['slug' => 'engine-mount',  'name' => 'Engine Mount',     'category_key' => 'engine',       'tracking_mode' => 'batch', 'expected_life_km' => 120000, 'position_scheme' => null],
    ['slug' => 'brake-caliper', 'name' => 'Brake Caliper',    'category_key' => 'brakes',       'tracking_mode' => 'batch', 'expected_life_km' => 150000, 'position_scheme' => 'axle_corner'],
    ['slug' => 'control-arm',   'name' => 'Control Arm',      'category_key' => 'suspension',   'tracking_mode' => 'batch', 'expected_life_km' => 100000, 'position_scheme' => 'axle_corner'],
    ['slug' => 'wheel-bearing', 'name' => 'Wheel Bearing',    'category_key' => 'suspension',   'tracking_mode' => 'batch', 'expected_life_km' => 120000, 'position_scheme' => 'axle_corner'],
    ...
    ['slug' => 'stabilizer-link', 'name' => 'Stabilizer Link', 'category_key' => 'suspension',  'tracking_mode' => 'batch', 'expected_life_km' => 60000, 'position_scheme' => 'axle_corner'],
    ['slug' => 'tie-rod-end',   'name' => 'Tie Rod End',      'category_key' => 'suspension',   'tracking_mode' => 'batch', 'expected_life_km' => 100000, 'position_scheme' => 'axle_corner'],
