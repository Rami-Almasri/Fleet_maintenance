...
const en = {
  ...
  workflow: {
    ...
    hint: {
      ...
      observationNoMedia: 'Photos and videos aren’t attached to observations — describe what you noticed in the note instead.',
...
const ar = {
  ...
  workflow: {
    ...
    hint: {
      ...
      observationNoMedia: 'لا تُرفق الصور والفيديو مع الملاحظات — صف ما لاحظته في نص الملاحظة.',
