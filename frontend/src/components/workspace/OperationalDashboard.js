...
const KPIS = [
  ...
  { key: 'service_due', label: 'Due for Service',     tone: 'amber',   modules: ['maintenance', 'fleet-intelligence'],   icon: <Icon.Spark className="h-5 w-5" />,  to: '/service-due', permission: 'insights.view', flag: 'intel', hint: 'Overdue or approaching', get: (m) => m.serviceDue },
