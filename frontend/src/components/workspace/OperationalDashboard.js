...
const KPIS = [
  ...
  { key: 'workshop',    label: 'In Workshop',         tone: 'amber',   modules: ['maintenance'],                         icon: <Icon.Wrench className="h-5 w-5" />, to: '/maintenance-workflow', permission: 'maintenance.view', hint: 'Down for maintenance',      get: (m) => m.maint },
  ...
  { key: 'overdue_m',   label: 'Overdue Maintenance', tone: 'red',     modules: ['maintenance'],                         icon: <Icon.Clock className="h-5 w-5" />,  to: '/maintenance-workflow', permission: 'maintenance.view', hint: 'Past their ready-by target', get: (m) => m.overdueMaintenance },
