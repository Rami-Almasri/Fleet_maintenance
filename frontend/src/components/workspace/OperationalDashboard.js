...
const KPIS = [
  ...
  { key: 'service_due', label: 'Due for Service',     tone: 'amber',   modules: ['maintenance', 'fleet-intelligence'],   icon: <Icon.Spark className="h-5 w-5" />,  to: '/service-reminders', permission: 'reminders.view', hint: 'Overdue or approaching', get: (m) => m.serviceDue },
