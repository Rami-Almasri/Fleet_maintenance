      ...
      {open && (
        <div className="border-t border-slate-100 px-6 py-5">
            ...
            <DataTable
              ...
              columns={[
                ...
                { key: 'settled', header: 'Settled', align: 'right', cellClass: 'tabular-nums text-slate-600', render: (r) => aed2(r.settled) },
                {
                  ...
                  tooltip: 'Charged − Settled per category. Red = still owed; green = in the customer’s favour (e.g. a discount).',
                  render: (r) => (
          ...
          <p className="mt-2 text-xs text-slate-500">
            ...
            <span className="font-medium text-slate-700">{balance < 0 ? 'credit / wallet' : 'balance'} ({aed2(Math.abs(balance))})</span>.
