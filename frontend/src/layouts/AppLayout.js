...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      // The historical damage log left this group — it is a READ of what was imported, one more
      // per-car ledger, so it is a tab of Vehicles (Records) beside Completed Repairs and History.
      // What stays here is the WORK: a live crash file with a police report to chase, a fault to
      // rule on, an insurer to chase and money to settle, and it is the surface that stops a
      // damaged car being re-let.
